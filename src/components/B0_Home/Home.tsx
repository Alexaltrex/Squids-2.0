...
export const Home: FC<IHome> = () => {
    ...
    const navigateToTournament = useCallback(() => navigate('/home2', {replace: true}), [navigate]);


    function tryNavigateToTournament() {
        //TODO just for max without metamask
    ...
    return (
        ...
        >
            <div className={style.innerWrapper}>
                <GlitchText duration={3000} color1="rgba(30, 171, 245, 1)" color2="rgba(245, 0, 87, 1)"
                            disabled={isDisabled}>
